        ...
        <div className="bg-[#DFE1E6] " >
          <div className="space-y-30">
            <div className="flex items-center space-x-4 pt-10">
              ...
              <h2 className="font-[Roboto] font-light text-[70px]">01.</h2>
              <div>
            ...
            <div className="flex items-center space-x-4 pl-20">
              <div className="w-[100px] h-[2px] bg-black "></div>
              <h2 className="font-[Roboto] font-light text-[70px]">02.</h2>
              <div>
            ...
            <div className="flex items-center space-x-4 pl-30">
              <div className="w-[100px] h-[2px] bg-black "></div>
              <h2 className="font-[Roboto] font-light text-[70px]">03.</h2>
              <div>
            ...
            <img className="lg:px-[130px] px-[0]" src={Mockup00} alt="makai" />
