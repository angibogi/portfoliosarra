...
const experience = () => {
  return (
    <div id="services" className="w-full pt-20 lg:px-[150px] px-[30px] ">
<div>
    ...
    <div className="flex flex-col justify-center items-start gap-6">
        ...
        <div className="flex flex-col justify-center items-start gap-3">
            <p className="text-[#8491A0] text-[117px]">01</p>
    ...
    <div className="flex flex-col justify-center items-start gap-6">
        <div>
        <div className="flex flex-col justify-center items-start gap-3">
        <p className="text-[#8491A0] text-[117px]">02</p>
    ...
    <div className="flex flex-col justify-center items-start gap-6">
        <div>
        <div className="flex flex-col justify-center items-start gap-3">
        <p className="text-[#8491A0]  text-[117px]">03</p>
